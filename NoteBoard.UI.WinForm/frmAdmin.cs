...
namespace NoteBoard.UI.WinForm
{
    public partial class frmAdmin : Form
    {
        ...
        private void lvUsers_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Bu kullancıyı onaylıyormusunuz ?","Onay",MessageBoxButtons.YesNoCancel,MessageBoxIcon.Question);
        ...
        {
            this.Owner.Show();
            (this.Owner as frmLogin).SorunCozenMethod();
        }
    }
}
